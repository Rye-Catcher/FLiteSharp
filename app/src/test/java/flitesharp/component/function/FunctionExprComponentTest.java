...
public class FunctionExprComponentTest {
    ...
    public void evaluateBody_ABGivenAsArguments_shouldReturnAPlusB() {
        ...
        DataComponent result = new FunctionExprComponent(params, body, emptyEnv, type).evaluateBody(arguments);
        result.setType(new TypeElement(TypeName.INT));
